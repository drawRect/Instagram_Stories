...
extension UIImageView {
    ...
    struct ActivityIndicator {
        ...
        static var view = aiView
        static var aiStyle: UIActivityIndicatorView.Style {
        ...
        static var aiView: UIActivityIndicatorView {
            if #available(iOS 13.0, *) {
    ...
    public var activityStyle: UIActivityIndicatorView.Style {
        get {
            guard let value = objc_getAssociatedObject(
                self, &ActivityIndicator.style) as? UIActivityIndicatorView.Style else {
                    if #available(iOS 13.0, *) {
                        return .large
                    } else {
                        return .whiteLarge
        ...
        set(newValue) {
            objc_setAssociatedObject(
                self, &ActivityIndicator.style, newValue, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
    public var activityIndicator: UIActivityIndicatorView {
        ...
        set(newValue) {
            ...
            objc_setAssociatedObject(
                self, &ActivityIndicator.view, activityView, objc_AssociationPolicy.OBJC_ASSOCIATION_RETAIN_NONATOMIC)
        }
    }
